...
R can import data in just about every form imaginable:
...
.pull-right[
![r data imports](http://www.sthda.com/sthda/RDoc/images/importing-data-into-r.png)
]
...
# Visualisation with ggplot2 - Example
...
All your coding is only going to be useful if you can effectively communicate the findings to non-coders, in formats they are comfortable with.
...
Head over to our [eventbrite page](https://www.eventbrite.co.uk/e/master-data-with-code-tickets-50351709318) to sign up, or [get in touch here](https://cultureofinsight.com/contact) if you'd like to know more!
